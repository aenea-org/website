...
const features = [
    {
        ...
        description: "Il sistema suggerisce ottimizzazioni e previene errori comuni mentre lavori. Come avere un esperto al tuo fianco, 24/7."
    },
    {
        icon: (
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const steps = [
    { number: "01", label: "Descrivi", desc: "Definisci la logica" },
    { number: "02", label: "Genera", desc: "Sintesi automatica" },
    { number: "03", label: "Verifica", desc: "Validazione istantanea" },
];
                ...
                <ScrollReveal>
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight mb-4">
                            Un workflow che{' '}
                            <span className="gradient-text-blue">lavora per te.</span>
                        </h2>
                        <p className="text-lg text-[#888] max-w-2xl mx-auto">
                            Abbiamo ripensato il flusso di progettazione elettronica eliminando
                            i passaggi ripetitivi. AENEA gestisce la struttura e la validazione,
                            tu ti concentri sulla logica e sull&apos;architettura.
                        </p>
                    </div>
                </ScrollReveal>
